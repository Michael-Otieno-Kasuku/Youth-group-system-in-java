...
public class ShortLoan extends AccountCreationMenu {
    public void ShortLoan(){
        int amount;
        ...
        if(amount <=balance*2 ){
            ...
            System.out.print("The maximum loan you can get is "+balance*2+"\n");
            System.out.print("\nPlease try again! \n");
            ShortLoan();//recursive call
        }
    }
}
